...
<head>
    ...
    <title>Register Owner - Profile - Courtee</title>
...
<body class="bg-courtee-100/40 min-h-screen flex items-center justify-center px-6 py-12">
    ...
    <div class="bg-white rounded-3xl shadow-lg w-full max-w-lg p-10">
        ...
        <div class="flex flex-col items-center mb-8">
            ...
            <button class="mt-3 px-5 py-2 border border-gray-200 rounded-lg text-sm text-gray-600 hover:bg-gray-50 transition">
                Pilih foto profil
            </button>
        </div>

        <form action="{{ route('register.profile.owner.post') }}" method="POST" class="space-y-5">
            @csrf
            <div>
            ...
            <div>
                ...
                <input type="text" placeholder="16/06/2000"
                    class="w-full border border-gray-200 rounded-xl px-5 py-3 text-sm outline-none focus:border-courtee-400 transition">
            </div>

            <div class="grid grid-cols-5 gap-3">
                <div class="col-span-2">
                    <label class="text-sm text-gray-500 mb-1 block">Bank</label>
                    <input type="text" placeholder="BNI"
                        class="w-full border border-gray-200 rounded-xl px-5 py-3 text-sm outline-none focus:border-courtee-400 transition">
                </div>
                <div class="col-span-3">
                    <label class="text-sm text-gray-500 mb-1 block">Nomor Rekening</label>
                    <input type="text" placeholder="13473891"
                        class="w-full border border-gray-200 rounded-xl px-5 py-3 text-sm outline-none focus:border-courtee-400 transition">
                </div>
            </div>
